...
const LoginPage = () => {
  return (
    <>
      <div
        className="background-image pt-11"
        style={{ backgroundImage: `url(${image})`, backgroundSize: 'cover', minHeight: '100vh' }}
      >
        <div className="form bg-gray-900 bg-opacity-80 rounded-lg w-1/2 max-w-xs mx-auto mb-2">
          <div className="p-2">
            <h2 className="text-orange-500 bg-white rounded py-2 px-2 mb-4 ">Login Here</h2>
          </div>
